...
@interface WBNewsViewController ()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>

@end

@implementation WBNewsViewController
...
- (void)viewDidLoad {
    ...
    /*
     导航栏右边按钮设置属性
     */
    UIImage *rightImage1=[UIImage imageNamed:@"navigationbar_icon_newchat"];
    UIImage *rightImage2=[UIImage imageNamed:@"navigationbar_icon_newchat_highlight"];
